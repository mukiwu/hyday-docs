...
作业系统支援状态详细说明macOS 12+主要支援提供 Apple Silicon(arm64) 与 Intel(x64) 原生建置版本，为开发团队主要使用平台Windows 10 / 11稳定支援提供标准 NSIS 安装程序(x64 架构)，包含数位签署的自动更新套件Linux暂不支援
...
硬件项目最低需求建议配置macOS 版本12 (Monterey)14 (Sonoma) 或更新版本Windows 版本10 (22H2)11随机存取记忆体 (RAM)4 GB8 GB 或以上磁碟剩余空间500 MB1 GB 以上 (视笔记与附件量而定)
