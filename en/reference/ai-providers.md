...
## Supported Providers
   ...
   Provider Mode Tool Calling Requirements    OpenAICloudSupportedAPI key Anthropic ClaudeCloudSupportedAPI key Google GeminiCloudSupportedAPI key OpenRouterCloud aggregatorDepends on underlying modelAPI key OllamaLocalDepends on underlying modelLocal Ollama service Custom (OpenAI-compatible)Cloud / self-hostedDepends on endpoint configurationBase URL + API key  
