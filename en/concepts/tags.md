...
## Which Style to Use?
   ...
   Scenario Recommended     The whole note is about one topic Frontmatter   Only one paragraph relates to the topic Inline `#tag`   You want the tag inline so you can jump while reading Inline tag   You want search to find it, without cluttering the visual reading flow Frontmatter   
