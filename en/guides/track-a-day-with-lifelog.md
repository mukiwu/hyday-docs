...
Run "Summarize yesterday's notes" in Hyday Agent to extract the highlights.

![Hyday Agent summarizing yesterday's notes](https://hyday.tw/docs/screenshots/guides-track-a-day-with-lifelog-1.png)

## Advanced: Combine Entities and Tags

Adding entities and tags to the text next to a mark sharpens lineage analysis:

```
`-(14:30) Met with @Alice to talk through [[Q3 Execution Plan]] #work`
```
