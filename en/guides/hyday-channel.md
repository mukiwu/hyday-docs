...
## 5. How Channel Differs from Hyday Agent
    ...
    Hyday Agent Hyday Channel     Mode You ask, it answers Two-way — AI can initiate   Backend API / CLI / Ollama, any of them Claude Code (only)   Awareness Sees only the prompt you send Receives read/write activity in real time   Best for Concrete tasks, running skills Long companionship, live suggestions   
